...
GridView favoriteGridBuilder(context) {
  List likedProductData =
      context.watch<LikedProductProvider>().likedProductsData;

  return GridView.builder(
      physics: ScrollPhysics(),
      itemCount: likedProductData.length,
      shrinkWrap: true,
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          mainAxisSpacing: 15, crossAxisCount: 2),
      itemBuilder: (context, index) {
        double discount = double.parse(favorites[index].discountprice);
        double price = double.parse(favorites[index].price);
                            ...
                            children: [
                              Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    letterSpacing: -0.41,
                                    color: e['productDiscountPrice'] == '0'
                                        ? Color(0xFF34283E)
                                        : Color(0xFFCE3E3E),
                                  )),
                              SizedBox(
...
Card favoriteProductMethod(int index) {
  return Card(
    child: Container(
      height: 140,
      width: 163,
